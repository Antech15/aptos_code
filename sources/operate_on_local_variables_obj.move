module test::operate_on_local_variables_obj {
    use std::signer;
    ...
    public entry fun bad_object_write(account: &signer, object: Object<MyObject>) acquires MyObject{
    ...
    public entry fun good_object_write(account: &signer, object: Object<MyObject>) acquires MyObject{
        let object_address = object::object_address(&object);
        let object = borrow_global_mut<MyObject>(object_address);
